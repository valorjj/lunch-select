  ...
  return (
    <div className="auth-button">
      ...
      {showProviders && (
        <div className="auth-button__menu">
          <button
            className="auth-button__menu-item auth-button__provider"
            onClick={() => onLogin('google')}
          >
            <svg className="auth-button__provider-icon" width="18" height="18" viewBox="0 0 24 24">
          ...
          >
            <svg className="auth-button__provider-icon" width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
